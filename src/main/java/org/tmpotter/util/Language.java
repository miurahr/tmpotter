 ...
 * <p>
 * <p>This class tries to follow <a
...
public class Language implements Comparable<Object> {
    ...
    /**
     * Creates a new instance of Language, based on a string of a form "XX_YY" or
     * "XX-YY", where XX is a language code composed from 1-8 alpha (A-Za-z)
     * chars, and YY is a country ISO code composed from 1-8 alpha/digit
     * (A-Za-z0-9) chars.<br>
     * The form xx-xxxx-xx is also accepted, where "xxxx" is a 4 alpha characters
     * script as defined in
     ...
     * <a href="http://www.rfc-editor.org/rfc/bcp/bcp47.tx">BCP47</a>.
     */
    public Language(String str) {
        ...
        if (str != null) {
            Matcher match = AppConstants.LANG_AND_COUNTRY.matcher(str);
            if (match.matches() && match.groupCount() >= 1) {
                this.languageCode = match.group(1);
                if (match.group(2) != null) {
                    this.countryCode = match.group(2);
                }
    ...
    /**
     * Determine whether or not the language is space-delimited. Only Chinese and
     ...
     * <p>
     * The list contains all the ISO 639-1 codes. When there are country variants
     * (e.g., EN-US, EN-GB), they have been kept only when there are more than one
     ...
     * @return true  param is same object
     */
    @Override
     ...
     * <p>
     * <p>Basically returns a hashcode of
     * the underlying Locale object.
     *
     * @return hash code of locale
     */
    @Override
    public int hashCode() {
     ...
     *
     * @param obj object that is Language
     * @return language array index
     */
    @Override
    public int compareTo(Object obj) {
        if (obj instanceof Language) {
            return this.getLanguage().compareTo(((Language) obj).getLanguage());
        }
        return this.getLanguage().compareTo(obj.toString());
    }
