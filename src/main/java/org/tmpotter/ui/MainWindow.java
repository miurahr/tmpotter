...
public class MainWindow extends JFrame implements ModelMediator, ActionListener,
	 ...
	 *
	 * <p>
	 * Extracts from the TMX those lines having information which is useful for alignment, and
	 * puts them in the corresponding ArrayList's The left part in _alstOriginal corresponds to
	 * source text lines and the right part in _alstTranslation corresponds to the target text
	 * lines. Initialize the table with one line for each left and right line
	 *
	 */
	 ...
	 *
	 * <p>
	 * This function updates the rows in the table with the modifications performed, adds rows
	 * or removes them.
	 */
	@Override
